<template>
    <page-container id="policy-page">
        <div class="info">
            ...
            <li>
            <p><strong>Application</strong> refers to Tech Labs, the software program provided by the Company.</p>
            </li>
            <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Intiva Technologies, 197 Clearbrook Rd.</p>
            </li>
            <li>
            ...
            <li>
            <p><strong>Website</strong> refers to Tech Labs, accessible from <a href="https://intivatechlabs.com" rel="external nofollow noopener" target="_blank">https://intivatechlabs.com</a></p>
            </li>
            <li>
            ...
            <ul>
            <li>By email: info@intivatechnologies.ca</li>
            </ul>
        </div>
    </page-container>
</template>
...
<style>
    ...
    #policy-page h1, #policy-page h2, #policy-page h3, #policy-page h4{
        margin-bottom: 6pt;
    }
</style>